...
func NewConfigurations(logger hclog.Logger) *Configurations {
	...
	viper.SetDefault("MAIL_VERIFICATION_TEMPLATE_ID", "d-89773167bfeb499c9ba1ca1bcbe8cd41")
	viper.SetDefault("PASSWORD_RESET_TEMPLATE_ID", "d-a0c6f06c6f584fcba4c746ad3a29afcc")
